...
HD_PWD='/fs/student/ashishvyas/Downloads/Lab2A/Lab1B_handout/Lab1B/Lab1B.runs/system_axi_gpio_0_7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_gpio_0_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_gpio_0_7.tcl
